...
public class ProcessTest {
	...
	private static String docDir = "D:\\work\\JavaProject\\text-similarity\\HanLP-TextSimilarity-master\\src\\test\\resource\\doc\\";

	private static String txtDir = "D:\\work\\JavaProject\\text-similarity\\HanLP-TextSimilarity-master\\src\\test\\resource\\txt\\";
...
//		System.out.println("load 4");
	...
	public void demo4() throws IOException, TikaException {
		...
		for (int i = 1; i <= num_lcs; ++i) {
			//将之前的那一个lcs变成空，String 的lcs变量循环使用，留给下一次短一些的lcs
			if (i != 1) {
